...
[ -z "$PRODUCT_NAME" ] && PRODUCT_NAME="libcurl"
...
"$PROJECT_DIR"/build.sh "$CONFIGURATION_TEMP_DIR" "$CONFIGURATION_BUILD_DIR" "$ACTION" "$PRODUCT_NAME" "$CONFIGURATION" "$IPHONEOS_DEPLOYMENT_TARGET" "$PLATFORM"
